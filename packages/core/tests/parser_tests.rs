use quizseek_core::parser::{extract_csv, extract_epub, extract_excel, extract_html, extract_odt, extract_pptx, extract_txt, FileFormat, ParserError};
...
fn test_read_gb18030_txt() {
    let path = std::env::temp_dir().join("quizseek_test_gb18030.txt");
...
fn test_read_binary_rejected() {
    let path = std::env::temp_dir().join("quizseek_test_binary.bin");
...
fn test_read_utf8_bom_stripped() {
    let path = std::env::temp_dir().join("quizseek_test_bom.txt");
...
fn test_extract_csv_markdown_table() {
    let path = std::env::temp_dir().join("quizseek_test.csv");
...
fn test_extract_csv_escapes_pipes_and_newlines() {
    let path = std::env::temp_dir().join("quizseek_test_esc.csv");
...
fn test_extract_csv_empty_rejected() {
    let path = std::env::temp_dir().join("quizseek_test_empty.csv");
    std::fs::write(&path, "\n\n").unwrap();
...
fn test_extract_excel_markdown_table() {
    let path = std::env::temp_dir().join("quizseek_test.xlsx");
    write_min_xlsx(&path);
...
fn test_extract_excel_invalid_rejected() {
    let path = std::env::temp_dir().join("quizseek_test_bad.xlsx");
...
fn test_extract_html_strips_tags() {
    let path = std::env::temp_dir().join("quizseek_test.html");
...
fn test_extract_html_empty_rejected() {
    let path = std::env::temp_dir().join("quizseek_test_empty.html");
...
fn test_extract_pptx_slides_in_order() {
    let path = std::env::temp_dir().join("quizseek_test.pptx");
    write_min_pptx(&path);
...
fn test_extract_epub_spine_order() {
    let path = std::env::temp_dir().join("quizseek_test.epub");
    write_min_epub(&path);
...
fn test_extract_odt_paragraphs() {
    let path = std::env::temp_dir().join("quizseek_test.odt");
    write_min_odt(&path);
