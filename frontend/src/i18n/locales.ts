...
export const zhTW: LocaleMessages = {
  ...
  configSectionEndpoint: '接口地址',
  configSectionAuth: '认证密鑰',
  configSectionModel: '模型選擇',
  configApiUrl: 'API 地址',
  configApiKey: 'API Key',
  configFetchModels: '获取模型列表',
  configSelectModel: '選擇模型',
  configEnterModel: '或手动输入模型名',
  configSave: '儲存配置',
  configSaved: '已儲存',
  configReady: '配置完成，可以开始生成試題了',
  configReadyCta: '开始出題',
  configAiProvider: 'AI 提供商',
  configCfFree: 'Cloudflare 免费 AI',
  configCustomApi: '自定义 API',
  ...
  practiceEmptyTitle: '暂无題庫',
  practiceEmptyHint: '匯入 CSV/Excel 文件或将生成的試題儲存为題庫',
...
export const ja: LocaleMessages = {
  ...
  joinedReenter: '再入場',
  pubViewResults: '成績を確認',
  pubDeleteRecord: '記録を削除',
  ...
  configSectionEndpoint: 'APIエンドポイント',
  configSectionAuth: 'APIキー',
  configSectionModel: 'モデル選択',
  configApiUrl: 'API URL',
  configApiKey: 'API Key',
  configFetchModels: 'モデル一覧を取得',
  configSelectModel: 'モデルを選択',
  configEnterModel: 'モデル名を直接入力',
  configSave: '設定を保存',
  configSaved: '保存しました',
  configReady: '設定が完了しました',
  configReadyCta: '問題作成を開始',
  configAiProvider: 'AIプロバイダー',
  ...
  genGenerating: '問題生成中...',
  genFileSelected: '選択されたファイル',
  genProgressParsing: 'ファイル解析中...',
  ...
  practiceEmptyHint: '生成した問題は自動的に問題集へ保存されます',
  ...
  practiceWrongPractice: '間違えた問題を解く',
  practiceContinue: '続行',
  practiceEnterBank: '開く',
  ...
  practiceLangZh: '中国語',
  practiceLangEn: '英語',
  wrongModeTitle: '間違えた問題ノート',
  wrongModeDesc: '弱点を集中的に復習してマスター',
...
export const ko: LocaleMessages = {
  ...
  previewQuestionCount: '총 {n} 문제 생성됨',
  tableNum: '#',
  tableType: 'Type',
  tableQuestion: '문제',
  tableOptions: '보기',
  ...
  settingsLanguage: '언어',
  settingsTheme: '테마',
  settingsAccentColor: 'Material You 테마 색상',
  accentBlue: '픽셀 블루',
  accentGreen: '민트 그린',
  accentCoral: '코랄 핑크',
  accentPurple: '라벤더 퍼플',
...
export const es: LocaleMessages = {
  ...
  previewQuestionCount: 'Total {n} preguntas generadas',
  tableNum: '#',
  tableType: 'Type',
...
export const fr: LocaleMessages = {
  ...
  previewQuestionCount: 'Total {n} questions générées',
  tableNum: '#',
  tableType: 'Type',
  tableQuestion: 'Question',
  tableOptions: 'Options',
  ...
  settingsTheme: 'Thème',
  settingsAccentColor: 'Palette Material You',
  accentBlue: 'Bleu Pixel',
  accentGreen: 'Vert Menthe',
  accentCoral: 'Coral Coucher de Soleil',
  accentPurple: 'Pourpre Iris',
  accentAmber: 'Ambre Citron',
  themeSystem: 'Système',
...
export const de: LocaleMessages = {
  ...
  previewQuestionCount: 'Insgesamt {n} Fragen generiert',
  tableNum: '#',
  tableType: 'Type',
  tableQuestion: 'Frage',
  ...
  accentAmber: 'Zitronen-Bernstein',
  themeSystem: 'System',
...
export const ru: LocaleMessages = {
  ...
  previewQuestionCount: 'Сгенерировано {n} вопросов',
  tableNum: '#',
  tableType: 'Type',
  ...
  settingsTheme: 'Тема',
  settingsAccentColor: 'Палитра Material You',
  accentBlue: 'Синий Pixel',
  accentGreen: 'Мятный зеленый',
  accentCoral: 'Кораловый закат',
...
export const ar: LocaleMessages = {
  ...
  previewQuestionCount: 'إجمالي {n} سؤالاً تم توليدها',
  tableNum: '#',
  tableType: 'Type',
